package com.lwp.baseproject.utils.invalid.dict;

import com.lwp.baseproject.utils.invalid.dict.impl.IsRepeatNameImpl;
...
@Repeatable(com.lwp.baseproject.utils.invalid.dict.IsRepeatName.list.class)
public @interface IsRepeatName {
    ...
    @Documented
    @interface list{
        com.lwp.baseproject.utils.invalid.dict.IsRepeatName[] value();
    }
}
