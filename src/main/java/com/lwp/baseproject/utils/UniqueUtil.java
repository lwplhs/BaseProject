package com.lwp.baseproject.utils;
...
public class UniqueUtil {
    ...
    public static Map<String, String> getAllSn(){
        ...
        if("LINUX".equals(os)) {
            ...
            String cpuid = UniqueUtil.getCPUSerial();
            String mainboard = UniqueUtil.getMotherboardSN();
            String disk = UniqueUtil.getHardDiskSN("c");
            String mac = UniqueUtil.getMac();
            snVo.put("cpuid",cpuid.toUpperCase().replace(" ", ""));
